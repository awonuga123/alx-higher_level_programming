...
In this project, I learnt how  to use string formatter in python3 with series of example.I began utilizing conditionals and loops in Python by using if, if ... else, break, continue, pass, and range statements with while and for loops. I practiced writing my own Python functions while learning about scope of variables, tracebacks, and arithmetic operators.
...
* **0. Positive anything is better than negative nothing**
  ...
  * Completion of the source code provide by ALX/HOLBERTON SCHOOLS

* **1. The last digit**
  *Python program that assigns a random signed number
  ...
  * Prints the string `Last digit of [number] is [last_digit]` followed by:
    ...
    * Followed by a new line.
  * Completion of the source code provided by ALX/HOLBERTON SCHOOLS

* **2. I sometimes suffer from insomnia. And when I can't fall asleep, I play what I call the alphabet game**
  * Python program that prints the alphabet
  in lowercase, not followed by a new line.
  * Using only one `print` and one loop.
  * Without storing characters in variables or importing modules.

* **3. When I was having that alphabet soup, I never thought that it would pay off**
  *Python program that prints the
...
* **4. Hexadecimal printing**
  *Python program that prints all numbers from
...
* **5. 00...99**
  *Python program that prints numbers from `0`
...
* **6. Inventing is a combination of brains and materials. The more brains you use, the less material you need**
  * Python program that prints all possible
...
* **9. There are only 3 colors, 10 digits, and 7 notes; its what we do with them that's important**
  * Python function that prints the last
  digit of a number.
...
* **12. Fizz Buzz**
  * Python function that prints the numbers from
...
* **13. Insert in sorted linked list**
  *C function that inserts a number
...
* **16. ByteCode -> Python #2**
  * Python function matching exactly a
